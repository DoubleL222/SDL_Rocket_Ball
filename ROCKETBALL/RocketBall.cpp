...
#pragma region Dynamic Elements
	...
	physComp->initCircle(b2BodyType::b2_dynamicBody, 20 / physicsScale, player1->getPosition() / physicsScale, playerDensity, playerFriction, playerRestitution, playerLinearDamping, playerAngularDamping, true, PLAYER, BOUNDARY | PLAYER | ABILITYBOX | SOCCERBALL);
	b2P1Origin = physComp->body->GetPosition();
	...
	physComp->initCircle(b2BodyType::b2_dynamicBody, 20 / physicsScale, player2->getPosition() / physicsScale, playerDensity, playerFriction, playerRestitution, playerLinearDamping, playerAngularDamping, true, PLAYER, BOUNDARY | PLAYER | ABILITYBOX | SOCCERBALL);
	b2P2Origin = physComp->body->GetPosition();
